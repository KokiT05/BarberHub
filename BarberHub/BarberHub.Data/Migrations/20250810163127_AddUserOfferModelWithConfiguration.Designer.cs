...
namespace BarberHub.Data.Migrations
{
    ...
    [Migration("20250810163127_AddUserOfferModelWithConfiguration")]
    partial class AddUserOfferModelWithConfiguration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BarberHub.Data.Models.UserOffer", b =>
                {
                    ...
                    b.Property<string>("Comment")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)")
                        .HasComment("Optional comment provided by the user");

                    b.Property<string>("Description")
                        .IsRequired()
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)")
                        .HasComment("SelectOffer Description");

                    b.Property<DateTime>("SelectedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 8, 10, 19, 31, 26, 711, DateTimeKind.Local).AddTicks(247))
                        .HasComment("Date and time when the offer was selected");

                    b.Property<decimal>("TotalPrice")
                        .HasPrecision(5, 2)
                        .HasColumnType("decimal(5,2)")
                        .HasComment("SelectOffer TotalPrice");

                    b.HasKey("UserId", "OfferId");

                    b.HasIndex("OfferId");

                    b.ToTable("SelectOffer", t =>
                        {
